...
Today we'll be going a bit deeper and looking at data manipulation and aggregation. We're going to focus heavily on the [dplyr](https://cran.rstudio.com/web/packages/dplyr/vignettes/introduction.html) package and get in to to some of the gritty realities of working with data.
