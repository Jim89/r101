...
* Perform all the cleaning we've discussed today in one (or at most two) pipes, in a clean, tidy and commented code file;
...
* Treat "from" and "to" as an adjacency list, make an adjacency matrix, plot and analyse the (directed) network.
