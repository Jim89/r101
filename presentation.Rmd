...
* Peform all the cleaning we've discussed today in one, clean and tidy code file;
* Create some exploratory plots using `ggplot2` - histograms of journey times, journeys over time, journey time vs. touch-in time; or
* Plot station visits on a map;
